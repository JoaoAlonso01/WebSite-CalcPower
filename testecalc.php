<html>
	...
	<link rel="stylesheet" href="testecalc.css" media="screen">
...
error_reporting(0);
   ...
   if(!empty($_REQUEST["txtnum"]) && !empty($_REQUEST["txtnum2"])  && !empty($_REQUEST["select"])&& !empty($_REQUEST["radiobutton"]))
   {
...
<?php
error_reporting(0);
   if(!empty($_REQUEST["txtnum3"])&& !empty($_REQUEST["txtnum4"])  && !empty($_REQUEST["select2"]))
   {
